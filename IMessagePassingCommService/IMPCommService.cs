 ...
 * --------------------
 * ver 2.1 : 24 Oct 2017
 * - moved ClientEnvironment and ServerEnvironment to new project Environment
 * ver 2.0 : 19 Oct 2017
...
namespace MessagePassingComm
{
  ...
  public class CommMessage
  {
    ...
    public ErrorMessage errorMsg { get; set; } = "no error";
        [DataMember]
        public Dictionary<String, HashSet<String>> dependecy { get; set; }
        [DataMember] 
        public List<List<String>> strongComponent { get; set; }
    ...
    public void show()
    {
      ...
      Console.Write("\n    command     : {0}", command);
      Console.Write("\n    arguments   :");
            if (arguments.Count > 0 && arguments[0].Length < 20)
            {
                Console.Write("\n      ");
            ...
            else if (arguments.Count > 0 && arguments[0].Length >= 20)
                Console.Write("some file content");
          Console.Write("\n    ThreadId    : {0}", threadId);
           Console.Write("\n    errorMsg    : {0}\n", errorMsg);
