 ...
 * --------------------
 * ver 1.2 :11/2 2018
 * - add some fields to help implement tarjon's algorithm 
 * ver 1.1 : 23 Aug 2018
...
namespace CsGraph
{
  ...
  public class CsGraph<V,E>
  {
    ...
    public Stack<CsNode<String,String>>  seen { set; get; }
    ...
    public CsGraph(string graphName)
    {
      ...
      startNode = null;
            seen = new Stack<CsNode<String,String>>();
    }
